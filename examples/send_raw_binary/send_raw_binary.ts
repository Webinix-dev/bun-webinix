...
<html>
  <head>
    <script src="webinix.js"></script>
      <title>Webinix 2 - Bun Send Raw Binary Example</title>
    <style>
      body {
    ...
    <body>
        <h1>Webinix 2 - Bun Send Raw Binary Example</h1>
        <br>
...
async function get_raw_picture(e: Webinix.Event) {
  const pictureRaw = new Uint8Array(await Bun.file("./webinix.jpeg").arrayBuffer());
